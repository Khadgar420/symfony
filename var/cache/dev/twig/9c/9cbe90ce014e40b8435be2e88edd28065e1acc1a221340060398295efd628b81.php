...
class __TwigTemplate_edeadb516a1d984c4f414e7770c544dc8f938a6211419bc55fe19c9bce3c5d20 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_header($context, array $blocks = [])
    {
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")) {
            // line 86
            echo "                                    ";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 86, $this->source); })()), "user", [], "any", false, false, false, 86), "username", [], "any", false, false, false, 86), array(), "EasyAdminBundle"), "html", null, true);
            echo "
                                ";
        } else {
            // line 88
    ...
    public function block_header_custom_menu($context, array $blocks = [])
    {
        ...
        if ($this->extensions['EasyCorp\Bundle\EasyAdminBundle\Twig\EasyAdminTwigExtension']->getBackendConfiguration("user.display_name")) {
            ...
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 119, $this->source); })()), "user", [], "any", false, false, false, 119), "username", [], "any", false, false, false, 119), "html", null, true);
            echo "</span>
                                ";
        }
        // line 121
                        ...
                        <div class=\"popover-content-section user-details {{ _user_has_logout or _user_is_impersonated ? 'user-has-actions' }}\">
                            ...
                            <p class=\"user-details-name\">
                                {% if is_granted('ROLE_ADMIN') %}
                                    {{  app.user.username |trans(domain = 'EasyAdminBundle') }}
                                {% else %}
                                    {{ _user_name }}
                                {% endif %}
                            </p>
...
", "@EasyAdmin/default/layout.html.twig", "C:\\Users\\NZXT\\Documents\\Symfony\\Symfony\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\default\\layout.html.twig");
    }
}
